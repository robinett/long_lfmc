...
def main():
    ...
    regrid_xr = True
    raw_static_fname = (
        "/scratch/users/trobinet/long_lfmc/trent_datasets/static/"
        "static_features_p36_250m_latlon_float32.pkl"
    )
    ds_fname = (
        '/scratch/users/trobinet/long_lfmc/trent_datasets/static/'
        'static_features_250m_latlon_float32.nc'
    )
    target_grid_fname = (
    ...
    if  regrid_xr:
        ...
        plot.plot_from_xarray(
            ...
            target_crs,
            target_crs,
            '/scratch/users/trobinet/long_lfmc/trent_datasets/regridding/plots/elev_regrid.png'
        )
