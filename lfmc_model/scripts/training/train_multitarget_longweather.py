...
def train_fold_k(
    ...
    if len(mu_i_test) == 0:
        ...
        if len(true_vv) > 0:
            print(
                f'testidation  MAE: {test_mae_vv:.4f}, RMSE: {test_rmse_vv:.4f}, R2: {test_r2_vv:.4f}, NLL: {test_nll_vv:.4f}'
            )
        if len(true_vh) > 0:
            print(
...
def main():
    ...
    # configs
    # directories, etc.
    input_data_dir = '/scratch/users/trobinet/long_lfmc/trent_datasets/lfmc_model/data/inputs_singletask_sarstats'
