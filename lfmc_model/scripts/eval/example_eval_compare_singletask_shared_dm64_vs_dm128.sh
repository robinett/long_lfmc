...
model_a_name="single_task_dm64"
model_a_ensemble_root="/scratch/users/trobinet/long_lfmc/final_lfmc/lfmc_model/outputs/lfmc_365_shared_ensemble"
model_a_ensemble_member_name_prefix="transformer_dm64_"
model_b_name="single_task_dm128"
model_b_ensemble_root="/scratch/users/trobinet/long_lfmc/final_lfmc/lfmc_model/outputs/lfmc_365_shared_ensemble"
